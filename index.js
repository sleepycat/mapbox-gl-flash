...
Flash.prototype.onAdd = function(map) {
  var flash = this
  ...
  document.addEventListener('mapbox.setflash', this.handleFlash)
...
Flash.prototype.onRemove = function () {
  this.container.parentNode.removeChild(this.container)
  document.removeEventListener('mapbox.setflash', this.handleFlash)
}
